...
public class CheckoutLoginScenarioTest extends BaseTest {
    ...
    public void NavigateToProductListPage() {
        checkOutLoginPage = storePage().navigateToProductListTheme2();
    }
    ...
    public void FB6987() {
        ...
        Assert.assertTrue(checkOutLoginPage.checkoutWithoutLoginOnProductList(url, homeData.ADDRESS_DELIVERY, checkoutDataTest.SELECT_INDEX_ADDRESS_LIST), "Login dialog did not display");
    }
}
