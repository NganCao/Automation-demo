...
public class EditOrder extends Setup {
    ...
    public Boolean checkPriceFlashSale(String flashSaleKey, String productName, Boolean isFlashSale, int cartQuantity, List<Integer> toppingTotalPrice, String sizeName) {
        List<Boolean> flag = new ArrayList<>();
        int scroll = 0;
        JsonAPIAdminReader.FlashSaleProduct flashSaleProduct = commonPagesTheme1().homePage.getFlashSaleProductObject(flashSaleKey, productName);
        actualRS = "";
