...
import com.fnb.utils.api.pos.helpers.JsonAPIPosReader.MenuItem;
...
public class HomePage extends Setup {
    ...
    public By languageOptions = By.xpath("//div[contains(@class,\"language-top-bar\")]//a");
    public By languageTxt = By.xpath("//span[contains(@class,\"Flag-Default\")]");
    public By vietnameseOption = By.xpath("(//div[contains(@class,\"language-top-bar\")]//a)[1]");
    public By englishOption = By.xpath("(//div[contains(@class,\"language-top-bar\")]//a)[2]");
    //-------------------account
    ...
    //cart
    public static By cartContainer = By.xpath("//div[contains(@class,\"cart-theme1-container\")]");
    public static By cartCheckout = By.xpath("//div[contains(@class,\"cart-checkout\")]");
    public static By cartQuantity = By.id("cart-quantity");
    //------------------- cart -empty
    ...
    private By languageDownArrown = By.xpath("//a[@class=\"link-language\"]/*[name()=\"svg\"]");
    ...
    private By productCartList = By.xpath("//div[contains(@class,\"cart-item-list\")]/div[contains(@class,\"cart-item\")]");
    ...
    private String productCartNameXP = "./following-sibling::div[contains(@class,\"cart-item-detail\")]//p[contains(@class,\"cart-product-name\")]";
    private String productCartPriceXP = "./following-sibling::div//div[contains(@class,\"cart-price\")]/span";
    private By productFlashSaleCartList = By.xpath("//div[contains(@class,\"cart-item-list\")]//div[contains(@class,\"flash-sale-border\")]");
    private By productNotFSImageList = By.xpath("//div[contains(@class,\"cart-item-list\")]/div[contains(@class,\"cart-item\")]/div[contains(@class,\"image\") and not(contains(@class,\"flash-sale-border\"))]");
    private String productCartFlashSaleThumbnail = ".//img[contains(@class,\"item-thumbnail\")]";
    private String productCartFlashSaleName = "./following-sibling::div[contains(@class,\"cart-item-detail\")]//p[contains(@class,\"cart-product-name\")]";
    private String productCartFlashSalePrice = "./following-sibling::div//div[contains(@class,\"cart-price\")]/span";
    private String productCartQuantity = "./following-sibling::div[contains(@class,\"cart-item-detail\")]//div[contains(@class,\"item-quantity\")]/span";
    private By addLocationComponent = By.id("deliveryAddressSelector");
    private By addLocationBackground = By.xpath("//div[@id=\"deliveryAddressSelector\"]/div");
    private By locationIcon = By.xpath("//div[@id=\"deliveryAddressSelector\"]//div[contains(@class,\"receiver-address-select-button\")]/*[name()=\"svg\"]");
    private By receiveAddressLabel = By.xpath("//div[@id=\"deliveryAddressSelector\"]//div[contains(@class,\"receiver-address-select-button\")]/span");
    private By selectBbranchButton = By.xpath("//div[@id=\"deliveryAddressSelector\"]//div[contains(@class,\"store-branch-address-select-button\")]");
    private By selectBbranchIcon = By.xpath("//div[@id=\"deliveryAddressSelector\"]//div[contains(@class,\"store-branch-address-select-button\")]/*[name()=\"svg\"]");
    ...
    //after clicking Delivery tab or select address
    private By addressLocationDialog = By.xpath("//div[contains(@class,\"modal-delivery-address-selector\")]");
    //after clicking Pickup tab or select store branch
    private By addressLocationDialog2 = By.xpath("//div[contains(@class,\"modal-delivery-address-selector\")]");
    private By deliveryTab = By.xpath("//div[contains(@class,\"header-container\")]/div[contains(@class,\"header-left\")]");
    private By pickupTab = By.xpath("//div[contains(@class,\"header-container\")]/div[contains(@class,\"header-right\")]");
    private By deliveryCTA = By.xpath("//div[contains(@class,\"title-branch-modal-left\")]");
    private By pickupCTA = By.xpath("//div[contains(@class,\"title-branch-modal-right\")]");
    private By deliveryCTASpan = By.xpath("//div[contains(@class,\"title-branch-modal-left\")]/span");
    private By pickupCTASpan = By.xpath("//div[contains(@class,\"title-branch-modal-right\")]/span");
    //Delivery
    private By locationDeliveryIcon = By.xpath("//*[@id=\"Location\"]/parent::*[name()=\"svg\"]");
    private By clearIcon = By.xpath("//span[contains(@class,\"ant-input-clear-icon\")]/*[name()=\"svg\"]");
    private By myAddreessContainer = By.xpath("//div[contains(@class,\"my-address-container\")]");
    private By myAddressItems = By.xpath("//div[contains(@class,\"my-address-container\")]//div[contains(@class,\"address-detail-box\")]");
    private By myAddressTitle = By.xpath("//div[@class=\"my-address-container\"]//div[@class=\"address-title\"]/span[1]");
    private By myAddressDefault = By.xpath("//div[@class=\"my-address-container\"]//span[@class=\"address-default-text\"]");
    private By myAddressAddress = By.xpath("//div[@class=\"my-address-container\"]//div[@class=\"address-detail-text\"]/span");
    //Pickup
    private By pickupSpan = By.xpath("//div[contains(@class,\"header-container\")]/div[contains(@class,\"header-right\")]/span");
    private By nearestBranchLabel = By.xpath("(//div[@class=\"text-branch-info\"])[1]");
    private By nearestBranchItem = By.xpath("(//div[@class=\"text-branch-info\"])[1]/ancestor::label");
    private By nearestBranchIcon = By.xpath("(//div[@class=\"text-branch-info\"])[1]/following-sibling::div//div[@class=\"address-icon\"]/*[name()=\"svg\"]");
    private By nearestBranchChecked = By.xpath("(//div[@class=\"text-branch-info\"])[1]/following-sibling::div//div[@class=\"selected\"]/*[name()=\"svg\"]");
    private By nearestBranchName = By.xpath("(//div[@class=\"text-branch-info\"])[1]/following-sibling::div//p[@class=\"address-label\"]/span[1]");
    private By nearestBranchDistance = By.xpath("(//div[@class=\"text-branch-info\"])[1]/following-sibling::div//p[@class=\"address-label\"]/span[2]");
    private By nearestBranchAddress = By.xpath("(//div[@class=\"text-branch-info\"])[1]/following-sibling::div//p[@class=\"address\"]");
    private By otherBranchLabel = By.xpath("(//div[@class=\"text-branch-info\"])[2]");
    private By otherBranchItems = By.xpath("(//div[@class=\"text-branch-info\"])[1]/ancestor::label/following-sibling::label");
    private By otherBranchNameList = By.xpath("(//div[@class=\"text-branch-info\"])[1]/ancestor::label/following-sibling::label//p[@class=\"address-label\"]/span[1]");
    private By otherBranchIconList = By.xpath("(//div[@class=\"text-branch-info\"])[1]/ancestor::label/following-sibling::label//div[@class=\"address-icon\"]/*[name()=\"svg\"]");
    private By otherBranchDistanceList = By.xpath("(//div[@class=\"text-branch-info\"])[1]/ancestor::label/following-sibling::label//p[@class=\"address-label\"]/span[2]");
    private By otherBranchAddressList = By.xpath("(//div[@class=\"text-branch-info\"])[1]/ancestor::label/following-sibling::label//p[@class=\"address\"]");
    private By otherBranchCheckedList = By.xpath("(//div[@class=\"text-branch-info\"])[1]/ancestor::label/following-sibling::label//div[@class=\"selected\"]/*[name()=\"svg\"]");
    private By branchItemList = By.xpath("//label[contains(@class,\"ant-radio-wrapper\")]");
    private By branchChecked = By.xpath("//label[contains(@class,\"ant-radio-wrapper\")]/span[contains(@class,\"ant-radio\")]");
    private By branchIconList = By.xpath("//div[contains(@class,\"address-icon\")]/*[name()=\"svg\"]");
    private By branchNameList = By.xpath("//p[@class=\"address-label\"]/span[1]");
    private By branchDistanceList = By.xpath("//p[@class=\"address-label\"]/span[2]");
    private By branchAddressList = By.xpath("//p[@class=\"address\"]");
    //define child element xpath of the branch information
    private String branchName = ".//p[@class=\"address-label\"]/span[1]";
    private String branchAddress = ".//p[@class=\"address\"]";
    private String branchDistance = ".//p[@class=\"address-label\"]/span[2]";
    ...
    private By productItemList = By.xpath("//div[@id=\"themeBestSellingProduct\"]//div[(contains(@class,\"swiper-slide\") and not(contains(@class,\" swiper-slide-duplicate \")) and contains(@class,\"swiper-slide-duplicate-\")) or (contains(@class,\"swiper-slide\") and not(contains(@class,\"swiper-slide-duplicate\")))]");
    ...
    private String productNameXpath = ".//div[contains(@class,\"product-name\")]";
    ...
    private By productActiveItem = By.xpath("//div[@id=\"themeBestSellingProduct\"]//div[contains(@class,\"swiper-slide-active\")]");
    ...
    private By productComponent = By.xpath("//div[@id=\"themeBestSellingProduct\"]");
    private By productSlider = By.xpath("//div[@id=\"themeBestSellingProduct\"]//div[contains(@class,\"swiper-wrapper\")]");
    ...
    private String productFlashSaleTag = ".//img[contains(@class,\"flash-sale-logo\")]";
    private String productFlashSaleBorder = ".//div[contains(@class,\"flash-sale-border\")]";
    private String productFlashsaleDiscount = ".//div[contains(@class,\"flash-sale-discount\")]/span";
    private String productFlashSaleOriginalXP = ".//span[contains(@class,\"discount-price\")]";
    //category
    ...
    private String flashSaleEndedSwiperId = ".//div[@id=\"rc-tabs-0-tab-0\"]";
    private String flashSaleComingSwiperId = ".//div[@id=\"rc-tabs-0-tab-2\"]";
    private String flashSaleEndAfterSwiperId = ".//div[@id=\"rc-tabs-0-tab-1\"]";
    private By flashSaleComingSwiper = By.xpath("//div[@id=\"themeFlashSale\"]//div[contains(@class,\"ant-tabs-tab-btn\")]/parent::div[contains(@class,\"ant-tabs-tab-active\")]//div[@id=\"rc-tabs-0-tab-2\"]");
    private By flashSaleEndAfterSwiper = By.xpath("//div[@id=\"themeFlashSale\"]//div[contains(@class,\"ant-tabs-tab-btn\")]/parent::div[contains(@class,\"ant-tabs-tab-active\")]//div[@id=\"rc-tabs-0-tab-1\"]");
    private By flashSaleEndedSwiper = By.xpath("//div[@id=\"themeFlashSale\"]//div[contains(@class,\"ant-tabs-tab-btn\")]/parent::div[contains(@class,\"ant-tabs-tab-active\")]//div[@id=\"rc-tabs-0-tab-0\"]");
    private By flashSaleItems = By.xpath("//div[@id=\"themeFlashSale\"]//div[starts-with(@id,\"rc-tabs-0-panel\") and @aria-hidden=\"false\"]//div[contains(@class,\"swiper-wrapper\")]//a");
    ...
    public Boolean checkDisplayAddLocationComponent() {
        return helper.checkDisplayElement(addLocationComponent);
    }

    public Boolean checkDisplayAddLocationIcon() {
        return helper.checkDisplayElement(locationIcon);
    }

    public Boolean checkSizeAddLocationIcon(int height, int width) {
        int iconH = driver.findElement(locationIcon).getSize().getHeight();
        int iconW = driver.findElement(locationIcon).getSize().getWidth();
        if (iconW == width && iconH == height) {
            return true;
        } else if (iconW != width) {
            actualRS = "Wrong WIDTH: " + iconW;
    ...
    public Boolean checkDisplayReceiveLocationLabel() {
        return helper.checkDisplayElement(receiveAddressLabel);
    }

    public Boolean checkFontSizeAddLocationLabel(String fontSize) {
        actualRS = helper.getCSSValue(receiveAddressLabel, "font-size");
    ...
    public Boolean checkColorAddLocationLabel(String color) {
        actualRS = Color.fromString(helper.getCSSValue(receiveAddressLabel, "color")).asHex();
    ...
    public Boolean checkDisplaySelectBranchButton() {
        return helper.checkDisplayElement(selectBbranchButton);
    }

    public Boolean checkColorSelectBranchButton(String color) {
        actualRS = Color.fromString(helper.getCSSValue(selectBbranchButton, "background-color")).asHex();
        if (actualRS.equals(color)) {
            return true;
        } else {
            return false;
    ...
    public Boolean checkFontSizeSelectBranchText(String fontSize) {
        actualRS = helper.getCSSValue(selectBbranchText, "font-size");
        if (actualRS.equals(fontSize)) {
            return true;
        } else {
            return false;
    ...
    public Boolean checkColorSelectBranchText(String color) {
        actualRS = Color.fromString(helper.getCSSValue(selectBbranchText, "color")).asHex();
        if (actualRS.equals(color)) {
            return true;
        } else {
            return false;
    ...
    public Boolean checkDisplaySelectBranchIcon() {
        return helper.checkDisplayElement(selectBbranchIcon);
    }

    public Boolean checkSizeSelectBranchIcon(int height, int width) {
        int iconH = driver.findElement(selectBbranchIcon).getSize().getHeight();
        int iconW = driver.findElement(selectBbranchIcon).getSize().getWidth();
        if (iconW == width && iconH == height) {
            return true;
        } else if (iconW != width) {
            actualRS = "Wrong WIDTH: " + iconW;
    ...
    public Boolean checkDisplaySelectBranchText() {
        return helper.checkDisplayElement(selectBbranchText);
    }

    public Boolean checkHeightAddLocation(int height) {
        int heightComponent = driver.findElement(addLocationComponent).getSize().getHeight();
    ...
    public Boolean checkColorAddLocation(String color) {
        actualRS = Color.fromString(helper.getCSSValue(addLocationBackground, "background-color")).asHex();
        return actualRS.equals(color);
    }

    public Boolean checkDisplayAddLocationComponentOnCheckout() {
        commonPagesTheme1().productDetailsPage.addToCart();
        helper.pressPageUpAction();
        helper.waitForClickable(driver.findElement(cartIcon));
    ...
    public CheckOutLoginPage clickCheckoutOnCart() {
        try {
            ...
            helper.waitUtilElementVisible(driver.findElement(cartCheckout));
            helper.clickBtn(driver.findElement(cartCheckout));
            helper.visibleOfLocated(CheckoutPage.bannerHeaderCheckout);
        } catch (Exception exception) {
            Log.info(exception.getMessage());
            helper.waitUtilElementVisible(driver.findElement(cartCheckout));
            helper.clickByJS(driver.findElement(cartCheckout));
    ...
    public void clickLocationLabel() {
        helper.visibleOfLocated(receiveAddressLabel);
        helper.clickBtn(driver.findElement(receiveAddressLabel));
    }

    public void clickSelectStoreBranch() {
        helper.visibleOfLocated(selectBbranchButton);
        helper.clickBtn(driver.findElement(selectBbranchButton));
    }

    public Boolean checkDisplayOfDeliveryTab() {
        Boolean check = false;
        check = helper.checkDisplayElement(deliveryTab);
        if (check == false) {
            check = helper.checkDisplayElement(deliveryCTA);
        }
        return check;
    }
    ...
    public Boolean checkDisplayOfPickupTab() {
        Boolean check = false;
        check = helper.checkDisplayElement(pickupTab);
        if (check == false) {
            check = helper.checkDisplayElement(pickupCTA);
        }
        return check;
    }

    public Boolean checkAlignOfAddLocationDialog(String align) {
        helper.waitUtilElementVisible(helper.getElement(addressLocationDialog));
        actualRS = helper.getCSSValue(addressLocationDialog, "vertical-align");
    ...
    public Boolean checkDisplayOfPickupLabel() {
        return helper.checkDisplayElement(pickupSpan);
    }

    public Boolean checkDisplayOfDeliveryLabel() {
        return helper.checkDisplayElement(deliverySpan);
    }
    ...
    public Boolean checkColorOfDelivery(String color, Boolean isTrue) {
        if (isTrue == true) {
            ...
            actualRS = Color.fromString(helper.getCSSValue(deliveryCTA, "background-color")).asHex();
        }
        if (actualRS.equals(color)) {
            return true;
        } else {
    ...
    public Boolean checkColorOfPickup(String color, Boolean isTrue) {
        if (isTrue == true) {
            ...
            actualRS = Color.fromString(helper.getCSSValue(pickupCTA, "background-color")).asHex();
        }
        if (actualRS.equals(color)) {
            return true;
        } else {
    ...
    public Boolean checkDisplayOfDeliveryInput(Boolean isDeliveryTab) {
        Boolean check = helper.checkDisplayElement(enterAddressField);
        if (check == false) {
            clickDelivery(isDeliveryTab);
    ...
    public Boolean checkDisplayOfDeliveryInputIcon() {
        return helper.checkDisplayElement(locationDeliveryIcon);
    }

    public Boolean checkDisplayClear() {
        return helper.checkDisplayElement(clearIcon);
    }

    public Boolean checkDisplayAddressList() {
        return helper.checkDisplayElement(addressBoxParent);
    }
    ...
    public Boolean checkNumberOfAddressItem(int expectedSize) {
        ...
        int listSize = helper.getElementList(addressBoxItems).size();
    ...
    public Boolean checkMatchKeySearchAddress(String address) {
        helper.waitForJStoLoad();
        List<WebElement> addressBoxList = helper.getElementList(addressBoxItems);
    ...
    public Boolean checkOutsideDialog() {
        ...
        return !helper.checkDisplayElement(addressLocationDialog);
    }

    public Boolean checkLabelAfterSelectAddress() {
        actualRS = helper.getText(receiveAddressLabel);
    ...
    public Boolean checkStoreAfterSelectAddress(String branchName) {
        actualRS = helper.getText(selectBbranchText);
        return actualRS.equals(branchName);
    }

    public Boolean checkDisplayOfAddressList(String phone, String password) {
        clickSelectAddress();
        return helper.checkDisplayElement(myAddreessContainer);
    }

    public Boolean checkDisplayAddressListTitle() {
        int addressListSize = helper.getElementList(myAddressItems).size();
        int addressIconListSize = helper.getElementList(myAddressTitle).size();
        if (addressIconListSize == addressListSize) {
            return true;
        } else {
            actualRS = String.valueOf(addressIconListSize);
            expectedRS = String.valueOf(addressListSize);
            return false;
        }
    }
    ...
    public Boolean checkDisplayAddressListAddress() {
        int addressListSize = helper.getElementList(myAddressItems).size();
        int addressIconListSize = helper.getElementList(myAddressAddress).size();
        if (addressIconListSize == addressListSize) {
            return true;
        } else {
            actualRS = String.valueOf(addressIconListSize);
    ...
    public Boolean checkDisplayOfDefaultTag() {
        return helper.checkDisplayElement(myAddressDefault);
    }

    public Boolean checkDisplayOfAddressLabelAfterSelectMyAddress(int addressIndex) {
        expectedRS = helper.selectOptionDropdown(myAddressItems, addressIndex);
        return expectedRS.contains(driver.findElement(receiveAddressLabel).getText().trim());
    }

    public Boolean checkDisplayOfElementOnPickup() {
        Boolean nearest = helper.checkDisplayElement(otherBranchLabel);
        Boolean other = helper.checkDisplayElement(otherBranchLabel);
    ...
    public Boolean checkDisplayOfBranchList() {
        int size = helper.getElementList(branchItemList).size();
        if (size > 0) {
            expectedRS = String.valueOf(size);
            return true;
        } else return false;
    }
    ...
    public Boolean checkDisplayOfNearestBranchListItem() {
        return helper.checkDisplayElement(nearestBranchItem);
    }

    public Boolean checkDisplayOfNearestBranchListIcon() {
        return helper.checkDisplayElement(nearestBranchIcon);
    }

    public Boolean checkSizeNearestBranchListIcon(int height, int width) {
        int iconH = driver.findElement(nearestBranchIcon).getSize().getHeight();
        int iconW = driver.findElement(nearestBranchIcon).getSize().getWidth();
        if (iconW == width && iconH == height) {
            return true;
        } else if (iconW != width) {
            actualRS = "Wrong WIDTH: " + iconW;
    ...
    public Boolean checkDisplayOfNearestBranchListName() {
        return helper.checkDisplayElement(nearestBranchName);
    }

    public Boolean checkSizeOfNearestBranchListName(String size) {
        return helper.getCSSValue(nearestBranchName, "font-size").equals(size);
    }

    public Boolean checkFontWeightOfNearestBranchListName(String expected) {
        return helper.getCSSValue(nearestBranchName, "font-weight").equals(expected);
    }

    public Boolean checkDisplayOfNearestBranchListDistance() {
        return helper.checkDisplayElement(nearestBranchDistance);
    }

    public Boolean checkDisplayOfNearestBranchListAddress() {
        return helper.checkDisplayElement(nearestBranchAddress);
    }

    public Boolean checkSizeOfNearestBranchListAddress(String size) {
        helper.waitForPresence(nearestBranchAddress);
        helper.visibleOfLocated(nearestBranchAddress);
        actualRS = helper.getCSSValue(nearestBranchAddress, "font-size");
        return helper.getCSSValue(nearestBranchAddress, "font-size").equals(size);
    }

    public Boolean checkFontWeightOfNearestBranchListAddress(String expected) {
        actualRS = helper.getCSSValue(nearestBranchAddress, "font-weight");
        return helper.getCSSValue(nearestBranchAddress, "font-weight").equals(expected);
    }

    public Boolean checkDisplayOfNearestCheckedBranch() {
        return helper.checkDisplayElement(nearestBranchChecked);
    }

    public Boolean checkDisplayOfSelectedDefaultBranchChecked() {
        actualRS = helper.getAttribute(nearestBranchItem, "class");
        return actualRS.contains(defaultSelectBranch);
    }

    public Boolean checkColorOfSelectedDefaultBranchChecked(String color) {
        WebElement element = helper.getElement(nearestBranchChecked);
    ...
    public Boolean checkColorOfSelectedDefaultBranchIcon(String color) {
        WebElement element = helper.getElement(nearestBranchIcon);
        actualRS = Color.fromString(element.getCssValue("fill")).asHex();
        return actualRS.equals(color);
    }

    public Boolean checkDisplayOfOtherBranchListItem() {
        int size = helper.getElementList(otherBranchItems).size();
        actualRS = String.valueOf(size);
        if (size >= 0) {
            expectedRS = actualRS;
            return true;
    ...
    public Boolean checkDisplayOfOtherBranchListIcon() {
        return checkDisplayOfBranchListDetails(otherBranchIconList);
    }

    public Boolean checkDisplayOfOtherBranchListName() {
        return checkDisplayOfBranchListDetails(otherBranchNameList);
    }

    public Boolean checkDisplayOfOtherBranchListDistance() {
        return checkDisplayOfBranchListDetails(otherBranchDistanceList);
    }

    public Boolean checkDisplayOfOtherCheckedBranch() {
        return checkDisplayOfBranchListDetails(otherBranchCheckedList);
    }

    public Boolean checkDisplayOfOtherBranchListAddress() {
        return checkDisplayOfBranchListDetails(otherBranchAddressList);
    }

    public Boolean checkColorOfOtherBranchIconList(String color) {
        List<WebElement> list = helper.getElementList(nearestBranchIcon);
        String c;
        int countFail = 0;
        actualRS = "Wrong at positions:";
        for (int i = 0; i < list.size(); i++) {
            c = Color.fromString(list.get(i).getCssValue("fill")).asHex();
            if (!c.equals(color)) {
                countFail++;
                actualRS.concat(" " + i + 1);
            }
    ...
    public Boolean checkSizeOfOtherBranchIconList(String height, String width) {
        List<WebElement> list = helper.getElementList(otherBranchIconList);
        String iconH, iconW;
        String c;
        int countFailH = 0, countFailW = 0;
        actualRS = "Wrong at positions:\n";
        for (int i = 0; i < list.size(); i++) {
            iconH = list.get(i).getAttribute("heigth");
            iconW = list.get(i).getAttribute("width");
            if (!iconW.equals(width)) {
                actualRS.concat("Wrong WIDTH: " + iconW + "\n");
                countFailW++;
            } else if (!iconH.equals(height)) {
                actualRS.concat("Wrong HEIGHT: " + iconH + "\n");
                countFailH++;
            } else {
                actualRS.concat("Wrong ALl - H: " + iconH + " W: " + iconW + "\n");
                countFailH++;
                countFailW++;
            }
        }
        if (countFailH > 0 || countFailH > 0) {
            return false;
        } else return true;
    }

    public Boolean checkFontSizeOfOtherBranchListName(String size) {
        List<WebElement> list = helper.getElementList(otherBranchNameList);
        String c;
        int countFail = 0;
        actualRS = "Wrong at positions:";
        for (int i = 0; i < list.size(); i++) {
            c = list.get(i).getCssValue("font-size");
            if (!c.equals(size)) {
                countFail++;
                actualRS.concat(" " + i + 1);
            }
    ...
    public Boolean checkFontWeightOfOtherBranchListAddress(String expected) {
        ...
        actualRS = "Wrong at positions:";
        for (int i = 0; i < list.size(); i++) {
            c = list.get(i).getCssValue("font-weight");
    ...
    public Boolean checkDisplayAfterSelectBranch(int index) {
        List<WebElement> list = helper.getElementList(otherBranchItems);
        String branchName = helper.getElementList(otherBranchNameList).get(index).getText().trim();
        expectedRS = branchName;
        helper.clickByJS(list.get(index));
        helper.visibleOfLocated(selectReceiver);
        actualRS = driver.findElement(selectBbranchText).getText().trim();
        if (branchName.equals(actualRS)) {
            return true;
        } else {
            return false;
        }
    ...
    public Boolean checkColorBranchIconAfterSelectBranch(int index, String color) {
        List<WebElement> list = helper.getElementList(otherBranchIconList);
        actualRS = Color.fromString(list.get(index).getCssValue("fill")).asHex();
        if (actualRS.equals(color)) {
            return true;
        } else {
            return false;
    ...
    public Boolean checkColorCheckedIconAfterSelectBranch(int index, String color) {
        List<WebElement> list = helper.getElementList(otherBranchCheckedList);
        actualRS = Color.fromString(list.get(index).getCssValue("fill")).asHex();
        if (actualRS.equals(color)) {
            return true;
        } else {
    ...
    private String getSelectBranchText() {
        helper.visibleOfLocated(selectBbranchText);
        return helper.getText(selectBbranchText);
    }

    public Boolean checkBranchAfterAddAddress() {
        actualRS = getSelectBranchText();
        List<WebElement> distanceList = helper.getElementList(branchDistanceList);
        ...
        expectedRS = helper.getElementList(branchNameList).get(index).getText().trim();
        ...
        if (checkSelectBranchText == true && checkNearestBranch == true) {
            ...
            actualRS.concat(" is wrong. Expected: " + expectedRS);
            return false;
            ...
            actualRS = "Actual distance " + helper.getText(nearestBranchDistance) + "\nExpected distance: " + distanceList.get(index).getText() + "\nActual branch name: " + helper.getText(nearestBranchName) + "\nExpected branch name: " + helper.getElementList(branchNameList).get(index);
            return false;
        }
    }
    ...
    public Boolean selectBranchWithName(String branchName) {
        ...
        try {
            ...
            Log.info(exception.getMessage());
            helper.clickByJS(driver.findElement(selectBbranchButton));
        }
        helper.visibleOfLocated(nearestBranchLabel);
        List<WebElement> nameList = helper.getElementList(branchNameList);
        for (int i = 0; i < nameList.size(); i++) {
            if (nameList.get(i).getText().equals(branchName)) {
        ...
        helper.visibleOfLocated(selectBbranchText);
        return helper.getText(selectBbranchText).equalsIgnoreCase(branchName);
    }
    ...
    public void clickSelectAddress() {
        helper.waitForPresence(selectReceiver);
        helper.waitUtilElementVisible(driver.findElement(selectReceiver));
        try {
            helper.clickBtn(driver.findElement(selectReceiver));
        } catch (Exception exception) {
            Log.info(exception.getMessage());
            helper.clickByJS(driver.findElement(selectReceiver));
        }
    }

    public void clickDelivery(Boolean isTab) {
        if (isTab == true) {
            helper.visibleOfLocated(deliveryTab);
            helper.clickBtn(driver.findElement(deliveryTab));
        } else {
            driver.findElement(deliveryCTA).click();
        }
    }

    public void clickPickup(Boolean isTab) {
        helper.visibleOfLocated(addressLocationDialog2);
        try {
            driver.findElement(pickupTab).click();
        } catch (Exception exception) {
            Log.info(exception.getMessage());
            driver.findElement(pickupCTA).click();
        }
    }
    ...
    public void onlyFillDeliveryAddress(String address, int addressIndex) {
        ...
        expectedRS = helper.selectOptionDropdown(addressBoxItems, addressIndex);
    }
    ...
    public void enterAddress(String address, int addressIndex) {
        helper.visibleOfLocated(selectReceiver);
        String oldAddress = helper.getText(selectReceiver);
        enterDeliveryAddress(address, addressIndex);
        String newAddress = helper.getText(selectReceiver);
        int count = 3;
        while (count > 0) {
            ...
            newAddress = helper.getText(selectReceiver);
            count--;
        }
    }
    ...
    private Boolean checkLanguageOfAddLocation(String language) {
        ...
        helper.waitUtilElementVisible(driver.findElement(receiveAddressLabel));
        if (helper.commonLanguageCheckLocaleFile(language, "please Select Address", "text", receiveAddressLabel, homeDataTest.ADD_USER_LOCATION, keyList) == false) {
            actualRS = "Actual: " + helper.getText(receiveAddressLabel) + "\nExpected: " + helper.commonLanguageCheckLocaleFile(language, "please Select Address", "text", receiveAddressLabel, homeDataTest.ADD_USER_LOCATION, keyList);
            return false;
        } else {
            return true;
        }
    ...
    private Boolean checkLanguageOfAddLocationDialog(String language) {
        int failed = 0;
        actualRS = "Actual: \n";
        List<String> keyList = new ArrayList<>();
        keyList.add("deliveryTo");
        clickSelectStoreBranch();
        helper.waitUtilElementVisible(driver.findElement(deliveryCTASpan));
        if (helper.commonLanguageCheckLocaleFile(language, "delivery", "text", deliveryCTASpan, homeDataTest.ADD_USER_LOCATION, keyList) == false) {
            failed++;
            actualRS = "Actual: " + helper.getText(deliveryCTASpan) + "\nExpected: " + helper.commonLanguageCheckLocaleFile(language, "delivery", "text", deliveryCTASpan, homeDataTest.ADD_USER_LOCATION, keyList);
        }
        keyList.clear();
        keyList.add("pickUp");
        if (helper.commonLanguageCheckLocaleFile(language, "pickUp", "text", pickupCTASpan, homeDataTest.ADD_USER_LOCATION, keyList) == false) {
            failed++;
            actualRS = "Actual: " + helper.getText(pickupCTASpan) + "\nExpected: " + helper.commonLanguageCheckLocaleFile(language, "pickUp", "text", pickupCTASpan, homeDataTest.ADD_USER_LOCATION, keyList);
        }
        keyList.clear();
        keyList.add("autoCompletePlaceholder");
        clickDelivery(false);
        helper.waitUtilElementVisible(driver.findElement(enterAddressField));
        if (helper.commonLanguageCheckLocaleFile(language, "Enter address placeholder", "placeholder", enterAddressField, homeDataTest.ADD_USER_LOCATION, keyList) == false) {
            failed++;
            actualRS = "Actual: " + helper.getAttribute(enterAddressField, "placeholder") + "\nExpected: " + helper.commonLanguageCheckLocaleFile(language, "delivery", "placeholder", enterAddressField, homeDataTest.ADD_USER_LOCATION, keyList);
        }
        keyList.clear();
        keyList.add("nearestBranch");
        clickPickup(true);
        helper.waitUtilElementVisible(driver.findElement(nearestBranchLabel));
        if (helper.commonLanguageCheckLocaleFile(language, "nearestBranch", "text", nearestBranchLabel, homeDataTest.ADD_USER_LOCATION, keyList) == false) {
            failed++;
            actualRS = "Actual: " + helper.getText(nearestBranchLabel) + "\nExpected: " + helper.commonLanguageCheckLocaleFile(language, "delivery", "text", nearestBranchLabel, homeDataTest.ADD_USER_LOCATION, keyList);
        }
        keyList.clear();
        keyList.add("otherBranch");
        if (helper.commonLanguageCheckLocaleFile(language, "otherBranch", "text", otherBranchLabel, homeDataTest.ADD_USER_LOCATION, keyList) == false) {
            failed++;
            actualRS = "Actual: " + helper.getText(otherBranchLabel) + "\nExpected: " + helper.commonLanguageCheckLocaleFile(language, "delivery", "text", otherBranchLabel, homeDataTest.ADD_USER_LOCATION, keyList);
        }
        if (failed > 0) {
            return false;
        } else return true;
    ...
    private void checkAllAddUserLocation(List<Boolean> flag) {
        String currentLanguage = getCurrentLanguage();
        if (checkLanguageOfAddLocation(currentLanguage) == true) flag.add(true);
        else flag.add(false);
        if (checkLanguageOfAddLocationDialog(currentLanguage) == true) flag.add(true);
        else flag.add(false);
    }
    ...
    //branch - add user location
    public Boolean checkBranchList(double lat, double lng) {
        actualRS = "";
        ...
        helper.waitForJStoLoad();
        List<WebElement> elementList = helper.getElementList(branchItemList);
    ...
    public Boolean checkBranchWithoutAddress() {
        return checkBranchList(0, 0);
    }

    public Boolean checkBranchAfterEnterAddress(String address, int addressIndex) {
        Map<String, Double> location = helpersAPIPos.getLatLongByAddress(homeDataTest.ADDRESS_DELIVERY);
        enterDeliveryAddress(address, addressIndex);
        clickSelectStoreBranch();
        return checkBranchList(location.get("lat"), location.get("lng"));
    }
    ...
    public Boolean checkHeaderMenuItem() {
        ...
        if (menuItemsUI.size() == menuApi.size()) {
            ...
            actualRS = actualRS + "Actual: " + menuItemsUI.size() + " API: " + menuApi.size() + "\n";
            return false;
        }
    }
    ...
    private Boolean scrollProductSlider(WebElement slider, int numberOfImages, Boolean isRight) {
        ...
        for (int i = 0; i < numberOfImages; i++) {
            helper.visibleOfLocated(productActiveItem);
            index1 = Integer.parseInt(driver.findElement(productActiveItem).getAttribute("data-swiper-slide-index"));
            if (isRight == true) {
    ...
    public Boolean checkAutoScrollOfBestSelling(int timeScroll) {
        ...
        helper.waitForPresence(productActiveItem);
        helper.visibleOfLocated(productActiveItem);
        int tabIndex = Integer.parseInt(driver.findElement(productActiveItem).getAttribute("data-swiper-slide-index"));
        secondStart = (int) System.currentTimeMillis(); //LocalTime.now().getSecond();
        secondEnd = (int) System.currentTimeMillis();//LocalTime.now().getSecond();
    ...
    private List<String> getProductNameListFull() {
        ...
        productNameFlashSale.add(flashSaleDataTest.PRODUCT_FLASH_SALE_2);
        productNameFlashSale.add(flashSaleDataTest.PRODUCT_FLASH_SALE_3);
        productNameFlashSale.add(flashSaleDataTest.PRODUCT_FLASH_SALE_5);
        productNameFlashSale.add(flashSaleDataTest.PRODUCT_FLASH_SALE_6);
        productNameFlashSale.add(flashSaleDataTest.PRODUCT_FLASH_SALE_7);
        productNameFlashSale.add(flashSaleDataTest.PRODUCT_FLASH_SALE_8);
    ...
    public Boolean checkCartPriceWhenFlasSale(FlashSaleProduct flashSaleProduct, Boolean isFlashSale, Boolean isClickCart) {
        helper.waitForJStoLoad();
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (flashSaleProductName.contains(nameChecked)) {
                    ...
                    try {
                        ...
                        if (productCardList.get(i).findElement(By.xpath(productFlashsaleDiscount)).getText().equals(discountPercentFormatted.substring(1, discountPercentFormatted.length())))
                            flag.add(true);
                        else {
                            actualRS = actualRS + "Percent is wrong!\nActual: " + productCardList.get(i).findElement(By.xpath(productFlashsaleDiscount)).getText() + " Expected: " + discountPercentFormatted.substring(1, discountPercentFormatted.length()) + "\n";
                            flag.add(false);
                        }
                    } catch (Exception exception) {
                        Log.info(exception.getMessage());
        ...
        if (helper.checkDisplayElement(flashSaleComponent)) {
            ...
            if (flashSaleProductList.size() == cardList.size()) {
                for (int i = 0; i < flashSaleProductList.size(); i++) {
                    ...
                    //check href of <a>
                    if (flashSaleProduct.getProductId().equals(id)) {
                        flag.add(true);
                    } else {
        ...
        if (helper.checkDisplayElement(flashSaleComponent)) {
            ...
            for (int i = 0; i < cardList.size(); i++) {
                ...
                if (color.equals(flashSaleDataTest.PRODUCT_TAG_BG_COLOR)) flag.add(true);
                    ...
                    actualRS = actualRS + "Percent discount tag in position " + (i + 1) + " has wrong font-size.\nActual:" + Color.fromString(cardList.get(i).findElement(By.xpath(flashSalePercentLabelXP)).getCssValue("background")).asHex().toString() + " Expected: " + flashSaleDataTest.PRODUCT_TAG_BG_COLOR + "\n";
                    flag.add(false);
                }
    ...
    public String checkRemainingFlashSaleAfterReorder(String url, int cartQuantity, Boolean isEnterAddress, String address, int addressIndex) {
        ...
        String currentLanguage = getCurrentLanguage();
        checkoutPage = myOrderPage.clickReOrderBtn();
    ...
    public FlashSaleProduct getFlashSaleProductByName(String typeFlashSaleObjectJson, String productName) {
        return jsonAPIAdminReader.getFlashSaleProductFromJson(typeFlashSaleObjectJson, productName);
    }
}