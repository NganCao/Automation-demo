...
public class JsonAPIReader {
    private static String getTheme = JsonReader.getTheme;
    private static String enviroment = JsonReader.enviroment;
    ...
    public static ConfigAPIObject apiReader(String typeAPI) {
        ...
        JsonObject themeObject = accountConfig.get(getTheme).getAsJsonObject();
        JsonObject accountObject = new JsonObject();
        if (enviroment.equals("prod")) {
            accountObject = themeObject.get("prod").getAsJsonObject();
        } else if (enviroment.equals("stag")) {
            accountObject = themeObject.get("stag").getAsJsonObject();
        } else {
            accountObject = themeObject.get("dev").getAsJsonObject();
        }
