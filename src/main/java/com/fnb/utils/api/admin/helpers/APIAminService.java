...
import static com.fnb.utils.api.admin.helpers.JsonAPIAdminReader.*;
...
public class APIAminService {
    ...
    public static Product getProductBySearchName(String fullName) {
        ...
        return jsonAPIAdminReader.getProductBySearching(filePath);
    }
    ...
    public static String getProductByName(String productName, String size) {
        String price = "";
    ...
    private static FlashSale createFlashSaleSpecialBranchAPI(List<String> productNameList, String flashSaleName, LocalDateTime startDate, LocalDateTime endDate, List<String> branchesNameList) throws IOException {
        ...
        //change
        ((ObjectNode) jsonNode
                .get("createFlashSaleSpecialBranch")
                .get("body")
                .get("flashSale"))
                .put("name", flashSaleName)
                .put("startDate", startD)
                .put("startTime", startT)
                .put("endDate", endD)
                .put("endTime", endT)
                .put("isIncludedTopping", false);
        // Access "flashSaleProducts"
        ArrayNode flashSaleProductsArray = (ArrayNode) jsonNode
                .get("createFlashSaleSpecialBranch")
                .get("body")
                .get("flashSale")
        ...
        flashSaleProductsArray.removeAll();
        //Access "branchIds"
        ArrayNode flashSaleBranchIdsArray = (ArrayNode) jsonNode
                .get("createFlashSaleSpecialBranch")
                .get("body")
                .get("flashSale")
                .get("branchIds");
        ...
        //Access "products"
        ArrayNode productsArray = (ArrayNode) jsonNode
                .get("createFlashSaleSpecialBranch")
                .get("body")
                .get("flashSale")
                .get("products");
