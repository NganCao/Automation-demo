package com.fnb.utils.api.admin.helpers;
...
public class JsonAPIAdminReader {
    ...
    //product
    public static Product getProductBySearching(String filePath) {
    ...
    public static FlashSaleProduct getFlashSaleProductFromJson(String typeFlashSaleObjectJson, String productName) {
        String theme = "theme1";
        ...
        for (int i = 0; i < flashSaleProductsArray.size(); i++) {
            ...
            if (isSinglePrice == false) {
                ...
                if (productName.contains(flashSaleProductObj.get("name").getAsString())) {
                    System.out.println(priceName);
                    if (productName.contains(priceName)) {
                        flashSaleProduct.setName(flashSaleProductObj.get("name").getAsString() + " " + priceName);
                        System.out.println(flashSaleProduct.getName());
                ...
                if (productName.equals(flashSaleProductObj.get("name").getAsString())) {
                    flashSaleProduct.setName(flashSaleProductObj.get("name").getAsString());
                    System.out.println(flashSaleProduct.getName());
                    flashSaleProduct.setPrice(Integer.parseInt(flashSaleProductObj.get("price").getAsString()));
                    flashSaleProduct.setFlashSalePrice(Integer.parseInt(flashSaleProductObj.get("flashSalePrice").getAsString()));
                    flashSaleProduct.setFlashSaleQuantity(Integer.parseInt(flashSaleProductObj.get("flashSaleQuantity").getAsString()));
